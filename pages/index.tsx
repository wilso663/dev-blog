        ...
        <div className={styles["about-description"] + " mb-6"}>
          ...
          <div className="">
            ...
            <div className="cta-buttons flex mt-5 items-center">
              ...
              <a className="text-xs md:text-sm flex mr-5 px-2 py-2 md:px-3 md:py-3 border-2 border-cyan-500 shadow-md rounded bg-cyan-500 text-white hover:text-blue-700" href="./assets/Stephen's Resume.pdf" download="Stephen's Resume.pdf">Download Resume
                <svg version="1.1" fill="#FFF" className="fill-current ml-1" xmlns="http://www.w3.org/2000/svg"
	 width="20px" height="20px" viewBox="0 0 537.794 537.795">
                <g>
                  <g>
