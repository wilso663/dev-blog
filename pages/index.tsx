      ...
      <section className={styles["about-section"] + ' max-w-5xl mb-8'} id='about-section"'>
        ...
        <div className={styles["about-description"] + " mb-6"}>
          ...
          <div className="">
            ...
            <p>I'm a graduate of the University of South Carolina Upstate in Spartanburg, SC with a Bachelor's Degree in Computer Science. I have also completed the Scrimba career path bootcamp for frontend development, the certification is located <span className="inline-flex">here: 
              <a className="ml-2 mt-1 hover:fill-blue-500" href="https://scrimba.com/certificate/uB3mmVCW/gfrontend" target="_blank">
            ...
            <div className="cta-buttons flex mt-5 items-center">
              <a className="text-xs md:text-sm flex mr-5 px-2 py-2 md:px-3 md:py-4 bg-black text-white rounded-md shadow-md hover:text-blue-500" href="https://www.linkedin.com/in/wilso663" target="_blank">View Linkedin
              ...
              <a className="text-xs md:text-sm flex mr-5 px-2 py-2 md:px-3 md:py-3 border-2 border-gray-300 rounded-md shadow-md hover:text-blue-600" href="https://www.github.com/wilso663" target="_blank">View Github
              ...
              <a className="text-xs md:text-sm flex mr-5 px-2 py-2 md:px-3 md:py-3 border-2 border-cyan-500 shadow-md rounded bg-cyan-500 text-white hover:text-blue-700" href="../public/assets/Stephen's Resume.pdf" download="Stephen's Resume.pdf">Download Resume
              </a>
            </div>
            </div>
        </div>
