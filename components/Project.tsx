  ...
  return (
    <div className="project" style={{maxWidth: "350px"}}> 
      ...
      <div className="project--links flex justify-between" >
        <a className="bg-black pl-2 py-0 md:py-1 lg:py-3 hover:text-blue-500 flex flex-auto lg:mr-4 justify-center items-center rounded-md text-white  text-xs md:text-sm " href={props.demoURL} target="_blank" rel="noreferrer">
        ...
        <a className="hover:text-blue-500 flex flex-auto items-center justify-center rounded-md bg-white border-2 border-gray-300 text-xs md:text-sm" href={props.githubURL} target="_blank" rel="noreferrer">
